 ...
 * @typedef {STRING} bit-docs-type-annotate/types/nameExpression NAME-EXPRESSION
 *
 * Adds the `name` and other properties to
 * [bit-docs-type-annotate/types/valueData valueData] in using the
 * [bit-docs-js/tags/param @param] or [bit-docs-js/tags/param @option] tags.
 *
 ...
 *
 * @param {String} \(args\...\) If `name` is a function, `()` provides the
 * names of each argument.
 *
 * @param {String} '\...' An argument is variable. The argument can be given 0
 * or more times.
 *
 * @param {String} \=default `=default` provides the default value for the
 * type. For example:
 *
 ...
 * - `[eventType="change"]` The param is optional and has a default value of
 * "change".
 * - `handler(foo,bar)` The param is named "handler" and takes a foo and bar
 * argument.
 */
